...
def read_option():
    ...
    parser.add_argument("--ps", help="p_sample | Probability to earas modality of samples", type=float, default=0.0)
    parser.add_argument("--pm", help="p_modality | Probability to erase modality of samples", type=float, default=0.0)
    parser.add_argument("--local_cls_lambda", help='Local modalitiy classification loss lambda', type=float, default=0.1)
    parser.add_argument("--local_aln_lambda", help="Local align loss lambda", type=float, default=0.1)
    parser.add_argument("--global_aln_lambda", help="Global align loss lambda", type=float, default=0.1)
